...
public class ProductInfoPageTest extends BaseTest {
	...
	/*
	 * @Test() public void productImagecountTest(String searchkey,String
	 * ProdcutName,int imagecount) { searchPage =
	 * accountsPage.performSearch("MacBook"); productInfoPage =
	 * searchPage.selectProduct("MacBook Pro"); int actualImagecount =
	 * productInfoPage.getImageCount(); Assert.assertEquals(actualImagecount, 4); }
	 */
	...
	@Test()
	public void addToCarSingleProdcuttTest() {
		searchPage = accountsPage.performSearch("MacBook");
		productInfoPage = searchPage.selectProduct("MacBook Pro");
